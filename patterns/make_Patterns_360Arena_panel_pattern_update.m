...
Pats = zeros(LEDdotsVertically, LEDdotsAcross, panel_pattern.x_num, panel_pattern.y_num); 	%initializes the array with zeros% Construct the dot patterns within each dimention
% zeros 0 = dark, ones 1 = light
YPOS_TODRAW = 1;
